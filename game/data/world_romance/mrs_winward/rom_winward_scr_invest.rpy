label rom_winward_invest_returnnextday:
    $ RomanceWinward().Invest_SeenReturnNextDayScene = True
    ...
    menu rom_winward_invest_returnnextday_sexmenu:
        "Put it in her pussy.":
        ...
        "Put it in her ass.":
            ...
            jump rom_winward_invest_returnnextday_sexmenu

label rom_winward_invest_initiate_sex:
    ...
    menu rom_winward_invest_initiate_sex_menu:
        "How about a kiss?":
            ...
            jump rom_winward_invest_initiate_sex_menu

        "I was thinking you could wrap those lips around my cock.":
            jump rom_winward_invest_rep_bj

        "I was thinking about pinning you up against the wall.":
            jump rom_winward_invest_rep_doggy_wall

label rom_winward_invest_rep_doggy_wall:
    ...
    menu rom_winward_invest_rep_doggy_wall_sexmenu:
        "Try and put it in her ass":
            if RomanceWinward().UnlockedAnalSex:
                ...
                if not QstIsActive(EventArlenaOrderButtplugForWinward) and not QstIsOver(EventArlenaOrderButtplugForWinward):
                    $ QstStart(EventArlenaOrderButtplugForWinward)
                jump rom_winward_invest_rep_doggy_wall_sexmenu
...
label rom_winward_invest_visit_bedroom_miss:
    $ RomanceWinward().Invest_SetUpEveningScene = False
    ...
    menu rom_winward_invest_visit_bedroom_miss_sexmenu:
        "Put it in her pussy.":
        ...
        "Put it in her ass.":
            if RomanceWinward().UnlockedAnalSex:
                ...
                if not QstIsActive(EventArlenaOrderButtplugForWinward) and not QstIsOver(EventArlenaOrderButtplugForWinward):
                    $ QstStart(EventArlenaOrderButtplugForWinward)
                jump rom_winward_invest_visit_bedroom_miss_sexmenu
...
label rom_winward_invest_rep_bj:
...
########################################################################################################
label rom_winward_invest_first_impreg:
    show mc at cleft with easeinleft
...
label rom_winward_invest_rep_impreg:
    show mc at cleft with easeinleft
    "Upon entering into the store, a flustered Kionni hurried towards me."
    show mrs_winward at cright_f with easeinright
...
label rom_winward_invest_first_birth:
...
label rom_winward_invest_rep_birth:
    show mc at cleft with easeinleft
    "As I entered into the store, Mrs Winward, clutching two small cutely gurgling babies wrapped in warm cloths smiled towards me."
    show mrs_winward at cright_f with easeinright
    MRS_WINWARD @happy "Look little ones."
...
label rom_winward_invest_how_is_our_child:
...
label dialogue_mr_winward_invest_howareyou:
    MR_WINWARD @think "Hm?"
    MR_WINWARD @happy "Well my pockets sure are deeper! Heeheeee!"
    return

label dialogue_mr_winward_invest_discusswife:
