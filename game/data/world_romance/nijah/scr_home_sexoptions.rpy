label rom_Nijah_stage2_sexoptions_lines:
    ...
    menu:
        ...
        'Tell Nijah to get on the bed':
            ...
            menu:
                ...
                'Her asshole.':
                    ...
                    scene nijah_house_doggy_anal_finish with flash
                    $ PlaySexFx("audio/sex_sounds/nijah_miss_finish.ogg")
                    $ ReduceInfectionFromSex("nijah")
        ...
        'Tell Nijah to ride you':
            ...
            if CharIsVisiblyPreg("nijah"):
                scene nijah_house_cowgirl_preg_finish with flash
                $ UnlockGalFlag("nijah", "house_cowgirl", "var_preg")
            else:
                scene nijah_house_cowgirl_nopreg_finish with flash
