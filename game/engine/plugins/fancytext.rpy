# this one's used for parasite text stuff
python early:
    ...
    def _slow_shake(st, gt, delay, x = 0, y = 0):
        ...
        if not gt == -1:
            ...
            if st < gt:
                ...
                t.alpha = 1.0
                t.xoffset = RngInt(-x, x)
                t.yoffset = RngInt(-y, y)
    ...
    def _slow_shaking_slide(st, gt, delay, shake_x = 0, shake_y = 0, slide_x = 0, slide_y = 0):
        ...
        if not gt == -1:
            ...
            if st < gt:
                ...
                t.alpha = p
                t.xoffset = slide_x - (slide_x * p) + RngInt(-shake_x, shake_x)
                t.yoffset = slide_y - (slide_y * p) + RngInt(-shake_y, shake_y)
    ...
    def slow_nonsense(st, gt, delay):
        ...
        if not gt == -1:
            ...
            if st < gt:
                ...
                t.xoffset = RngInt(-10, 10)
                t.yoffset = RngInt(-10, 10)
                t.rotate  = RngInt(0, 360)
