...
style label_text:
    ...
    color "#f59a84"
    size NORMAL_LABEL_TEXT_SIZE

init python:
    def _refresh_font():
        style.default.size = LARGE_TEXT_SIZE if persistent.large_font else NORMAL_TEXT_SIZE
...
style button_tab is button_sel:
    xsize 350
    xalign 0.5
...
style main_menu_button_text is label_text:
    yalign 0.5
    hover_color "#ff7d55"
...
################# INVENTORY #################
style inv_itemSlot_qtyText is text:
    size 25
    xalign 1.0
    yalign 1.0
    xoffset -3
...
style menu_header_text is label_text:
    size 80
...
################# LOCALIZATION / EXTRA TEXT STYLES ##############
