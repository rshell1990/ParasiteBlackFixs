...
translate de strings:
    ...
    new "Sacrifices the damage you deal by 20%% for 2 turns and increases the damage your allies absorb by 40%% for 2 turns and recovers the energy of all of them (excluding you) by %s."
