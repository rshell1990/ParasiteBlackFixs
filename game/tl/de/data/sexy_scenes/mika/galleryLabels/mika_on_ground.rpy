...
translate de gallery_mika_on_ground_a6f220e4:
    ...
    "Mikas Wangen wurden wieder rot, und mit leicht zitternden Händen hakte sie ihre Finger in ihr Höschen und zog es ganz langsam herunter."

# game/data/sexy_scenes/mika/galleryLabels/mika_on_ground.rpy:33
translate de gallery_mika_on_ground_30f438af:
    ...
    "Als ihr Höschen auf ihre Knöchel fiel, spreizte sie leicht die Beine und gewährte mir einen freien Blick auf sowohl ihre engen, weiblichen Löcher als auch den baumelnden Schwanz zwischen ihren Beinen."

# game/data/sexy_scenes/mika/galleryLabels/mika_on_ground.rpy:37
translate de gallery_mika_on_ground_dbd0be0b:

    # MIKA "H-Here you go."
    MIKA "H-Hier, bitte."

# game/data/sexy_scenes/mika/galleryLabels/mika_on_ground.rpy:38
translate de gallery_mika_on_ground_ae11a5db:
    ...
    "Verlegen beobachtete und starrte Mika weiter in einer Mischung aus Neugier und Erregung, als sie spürte, wie mein Blick über ihre intimsten Stellen wanderte."

# game/data/sexy_scenes/mika/galleryLabels/mika_on_ground.rpy:39
translate de gallery_mika_on_ground_f552c2bb:

    # "After a few moments, she slowly pulled her panties back up and turned to face me once more."
    "Nach ein paar Augenblicken zog sie langsam ihren Slip wieder hoch und drehte sich wieder zu mir um."

# game/data/sexy_scenes/mika/galleryLabels/mika_on_ground.rpy:45
translate de gallery_mika_on_ground_ad816ebf:

    # MIKA @ blush "There, you've um... {i}Seen me{/i} now."
    MIKA @ blush "Da, du hast ähm... {i}mich jetzt gesehen{/i}."
