...
# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:4
translate ja gallery_nijah_prol_bj_b8198403:

    # "Laying on her side playfully, Nijah giggled:"
    "戯れに横たわり、ニジャはくすくす笑った："

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:5
translate ja gallery_nijah_prol_bj_ac57432e:

    # NIJAH "So, how was zat, {i}lover?{/i}"
    NIJAH "で、どうだった、{i}ダーリン？{/i}"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:6
translate ja gallery_nijah_prol_bj_69e3376a:

    # MC "It was... {i}*huff*{/i} pretty great..."
    MC "それは…{i}*はあ*{/i}最高だったよ…"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:7
translate ja gallery_nijah_prol_bj_02fdebd5:

    # NIJAH "I iz glad!"
    NIJAH "うれしいのじゃ!"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:11
translate ja gallery_nijah_prol_bj_fed0dda7:

    # NIJAH "You haz little more time before we finish."
    NIJAH "終わるまで、もう少し時間があるぜ。"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:12
translate ja gallery_nijah_prol_bj_f14fd51c:

    # NIJAH "I suck your cock for bit, if you like?"
    NIJAH "ちょっと君のチンポをしゃぶってあげるよ、よかったら？"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:13
translate ja gallery_nijah_prol_bj_859180d1:

    # MC "S-Sure..."
    MC "は、はい…"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:18
translate ja gallery_nijah_prol_bj_87dac4de:

    # "Nijah stuck out her tongue, slid it under the head of my cock, and then pulled the rest of me inside her warm, wet mouth."
    "ニアは舌を突き出し、僕のペニスの亀頭の下に滑り込ませると、残りの部分を温かく湿った口の中へと引き込んだ。"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:19
...
translate ja gallery_nijah_prol_bj_7257677b:
    ...
    NIJAH "我々がここへ来たのは交易が盛んな頃、当時は我らの地の間に新たな、より緩やかな交易路の話が多くあったが…"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:27
translate ja gallery_nijah_prol_bj_7ad9f963:

    # NIJAH "But zen ze ports were closed suddenly and many of us fled {i}here.{/i}"
    NIJAH "しかし、{i}その時{/i}港が突然閉鎖され、我々の多くはここへ逃げたのです。"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:28
translate ja gallery_nijah_prol_bj_b2e1d00b:
...
translate ja gallery_nijah_prol_bj_9661250a:
    ...
    "一瞬、ニジャは痛々しいほど悲しげな、今や手の届かない遠い地を懐かしむような表情を浮かべた。私が気付いたと悟ると、彼女は作り笑いを浮かべた。"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:30
translate ja gallery_nijah_prol_bj_a32edefc:

    # NIJAH "I am sorry, a sad face iz no good for a whore..."
    NIJAH "すまない、娼婦が浮かぬ顔をしているのはよくない…"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:31
translate ja gallery_nijah_prol_bj_1b6a07e6:

    # NIJAH "Let me make you smile instead!"
    NIJAH "代わりに私が笑顔にさせてあげる!"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:36
translate ja gallery_nijah_prol_bj_5bc51621:

    # "Nijah quickly brought her mouth back down onto my cock."
    "ニジャは素早く再び口を私のペニスに戻した。"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:37
translate ja gallery_nijah_prol_bj_194846d3:

    # "She ran her tongue up the length of me before gently licking at the head, teasing me with little flicks."
    "彼女は舌先でぼくの全身を這わせてから、先端を優しく舐め、ちろりと小さく刺激してくる。"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:38
translate ja gallery_nijah_prol_bj_6a9b53a5:

    # "Then she brought her mouth down around the rest, pushing me deep into her throat."
    "それから彼女は口を残りの部分に降ろし、私を喉の奥深くまで押し込んでいった。"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:39
translate ja gallery_nijah_prol_bj_8c8725ad:

    # NIJAH "Mmmm... {i}*Slurp!* *Slurp!*{/i}"
    NIJAH "む……{i}*ずるずるっ!* *ずるずるっ!*{/i}"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:40
translate ja gallery_nijah_prol_bj_0434bc31:

    # MC "A-Ahh..."
    MC "あ、ああ…"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:41
translate ja gallery_nijah_prol_bj_737c561e:

    # "As I began to feel myself slowly building towards an orgasm once again, I asked."
    "再びゆっくりと絶頂に向かって高まっていくのを感じながら、私は尋ねた。"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:42
translate ja gallery_nijah_prol_bj_ae03b701:

    # MC "S-So, do you get many customers?"
    MC "そ、そうなの、お客さんは多いか？"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:47
translate ja gallery_nijah_prol_bj_f89a3747:

    # NIJAH "{i}*PLOP*{/i} Hmm? Oh, Not really..."
    NIJAH "{i}*ポチャン*{/i} ん？いや、別に…"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:48
translate ja gallery_nijah_prol_bj_1c093f7c:

    # MC "Huh? But you’re so beautiful!"
    MC "えっ？でも、とってもきれいなのに!"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:49
translate ja gallery_nijah_prol_bj_89ce7672:

    # NIJAH "Ah! Thank you!"
    NIJAH "あっ!ありがとう!"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:50
translate ja gallery_nijah_prol_bj_63efbe31:

    # NIJAH "But no, many are wary of my people."
    NIJAH "だが違う、多くの者が我々の一族を警戒している。"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:51
translate ja gallery_nijah_prol_bj_068acee9:

    # NIJAH "We are not trusted by ze common folk."
    NIJAH "我々は庶民から信頼されておりません。"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:52
translate ja gallery_nijah_prol_bj_81a0ea5d:

    # NIJAH "Many think we are like, uhh, how you say, ‘leeches’?"
    NIJAH "多くの人が、私たちを、ええと、なんていうか、「ヒル」みたいだと思ってるんだよね？"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:53
translate ja gallery_nijah_prol_bj_e47c7f56:

    # NIJAH "But zis is not fair! Because we would go home if we could!"
    NIJAH "しかし、これはフェアじゃないぜ!だって、帰りたいものなら帰れるはずなのに!"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:54
translate ja gallery_nijah_prol_bj_c49fd91e:

    # MC "... I see."
    MC "…なるほど。"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:55
translate ja gallery_nijah_prol_bj_5fd3e6c2:

    # "Suddenly, Nijah stopped."
    "突然、ニージャは立ち止まった。"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:57
translate ja gallery_nijah_prol_bj_f22919cc:

    # MC "Huh? So soon?"
    MC "えっ？もう？"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:58
translate ja gallery_nijah_prol_bj_a09cf3ed:

    # NIJAH "You haz been here nearly an hour..."
    NIJAH "君はここに一時間近くいたね……"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:59
translate ja gallery_nijah_prol_bj_7bd9c72f:

    # MC "Oh shit! I didn’t even realise!"
    MC "くそ!気づかなかった!"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:60
translate ja gallery_nijah_prol_bj_21e15758:

    # NIJAH "Iz okay!"
    NIJAH "いいよ!"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:61
translate ja gallery_nijah_prol_bj_da4c2f3a:

    # "As I started to gather up my clothes, Nijah reached out to take my hand."
    "服をまとめ始めると、ニジャは私の手を取りに伸ばした。"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:62
translate ja gallery_nijah_prol_bj_4359b271:

    # NIJAH "... Wait moment!"
    NIJAH "…ちょっと待って!"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:63
translate ja gallery_nijah_prol_bj_e79ed82a:

    # MC "Huh?"
    MC "えっ？"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:68
translate ja gallery_nijah_prol_bj_c4a83d2a:

    # "Suddenly, Nijah lunged forward, sucking on my cock furiously, her lips tight around me as she slammed her mouth up and down."
    "突然、ニージャが飛びついてきて、私の竿を貪るように咥え、唇をきつく締めながら口を激しく上下させた。"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:69
translate ja gallery_nijah_prol_bj_e35b1955:

    # "I gasped as my already sensitive cock was suddenly and quickly overwhelmed by the hot, wet sensation."
    "すでに敏感になっていた男根が、熱く湿った感覚に瞬く間に包まれ、私は息を呑んだ。"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:70
translate ja gallery_nijah_prol_bj_8e65e8dc:

    # MC "F-Fuck!"
    MC "く、くそ!"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:71
translate ja gallery_nijah_prol_bj_86afa9ac:

    # NIJAH "{i}*Slurp!* *Slurp!*{/i} Mmm..."
    NIJAH "{i}*ずるっ!ずるっ!*{/i} うーん…"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:72
translate ja gallery_nijah_prol_bj_aa6abc7d:

    # MC "S-Shit! Nijah! I’m gonna cum again! I’m gonna—"
    MC "く、くそっ…!ニジャ!またイっちゃう…!またイきそうっ…!"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:73
translate ja gallery_nijah_prol_bj_e7a6e42a:

    # "With both hands wrapped around me, Nijah made sure to push me in as deeply as possible, moaning with anticipation."
    "両手で私を抱きしめながら、ニアは可能な限り深く押し込むようにし、期待に震える声を漏らした。"

# game/data/sexy_scenes/nijah/galleryLabels/brothel_bj.rpy:74
translate ja gallery_nijah_prol_bj_5db84fca:
...
translate ja gallery_nijah_prol_bj_443adfe5:

    # NIJAH "Oh no... I thinkz we are out of time, [player_name!t]!"
    NIJAH "しまった…時間切れみたいだ、[player_name!t]!"
