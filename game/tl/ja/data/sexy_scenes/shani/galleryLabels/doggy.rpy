...
translate ja gallery_shani_doggy_2937b9b3:

    # "Was the encounter..."
    "出会いは…"

# game/data/sexy_scenes/shani/galleryLabels/doggy.rpy:18
translate ja gallery_shani_doggy_vag_2c20955f:
...
translate ja gallery_shani_doggy_anal_cc8f1661:
    ...
    "シャニは私を静かで薄暗い路地へと連れて行き、そこで彼女は緊張しながらドレスをたくし上げ、壁にもたれて前かがみになった。そのきつく暗く色づいた肛門が、私に向かってウインクしているように見えた。"

# game/data/sexy_scenes/shani/galleryLabels/doggy.rpy:68
translate ja gallery_shani_doggy_anal_367e05d6:

    # SHANI "I uh, p-put some lube there so..."
    SHANI "あの…そこにローションを塗っ…塗っておいたから…"

# game/data/sexy_scenes/shani/galleryLabels/doggy.rpy:69
translate ja gallery_shani_doggy_anal_78e92b4f:

    # "Wasting little time, I moved behind Shani and pressed the head of my cock against her tight backdoor."
    "ほとんど時間を置かずに、私はシャニの背後に移動し、硬く締まった彼女の後門に肉棒の先端を押し当てた。"

# game/data/sexy_scenes/shani/galleryLabels/doggy.rpy:73
translate ja gallery_shani_doggy_anal_40b06eae:
...
translate ja gallery_shani_doggy_anal_8c96b2fe:

    # SHANI "F-Fuck! It still burns but... But it’s starting to feel... amazing!"
    SHANI "くっ…!まだヒリヒリするけど…でも…なんだか…すごく気持ちいい!"

# game/data/sexy_scenes/shani/galleryLabels/doggy.rpy:86
translate ja gallery_shani_doggy_anal_73c2bb00:
    ...
    "迷うことなく、シャニの締まったケツに深く突き入れ始めた。彼女が柔らかく丸い尻をこちらの方に押し返しながら、快楽でうめき声を漏らすのを聞きつつ。"

# game/data/sexy_scenes/shani/galleryLabels/doggy.rpy:87
translate ja gallery_shani_doggy_anal_c8e615db:
...
translate ja gallery_shani_doggy_anal_e446cb82:
    ...
    "シャニの体が火照り、私の体も同様に、彼女が震えながら私のペニスを締め付けるたびに、私が彼女に与えた絶頂の数を数え忘れていた。"

# game/data/sexy_scenes/shani/galleryLabels/doggy.rpy:92
translate ja gallery_shani_doggy_anal_d6a0a4ad:

    # SHANI "F-Finish in my ass! I want to feel you fill up my ass!"
    SHANI "出、出して、アナルの中に!アナルがいっぱいになるのを感じたいの!"

# game/data/sexy_scenes/shani/galleryLabels/doggy.rpy:93
translate ja gallery_shani_doggy_anal_827af321:
