...
translate ja sexscene_arwen_backdoor_16065fbd:
    ...
    "アルウェンの締まった肛門が、私の男根をぎゅっと締め付ける。彼女はすすり泣き、喘ぎながら、精一杯私に腰を押し返そうとするが、明らかに苦戦している様子だった。"

# game/data/world_romance/arwen/scr_ArwenDoggyAnal.rpy:42
translate ja sexscene_arwen_backdoor_cee5b607:
    ...
    "アルウェンの手が拳を握り締めると、彼女は震え、激しいセッションから瞳が潤み始め、下唇を強く噛みしめた。"

# game/data/world_romance/arwen/scr_ArwenDoggyAnal.rpy:43
translate ja sexscene_arwen_backdoor_ce7df690:

    # ARWEN "GHHH! You're so f-fucking big!"
    ARWEN "うわっ!おまれ、で、でっかいくそ!"
...
translate ja sexscene_arwen_backdoor_bac3ce87:
    ...
    "もう抑えきれない、火のように血管を焼き尽くす激しい快楽が私を狂わせ、寄生体が私の内側で疼くのを感じるほどだった。"

# game/data/world_romance/arwen/scr_ArwenDoggyAnal.rpy:71
translate ja sexscene_arwen_backdoor_12c696e5:
