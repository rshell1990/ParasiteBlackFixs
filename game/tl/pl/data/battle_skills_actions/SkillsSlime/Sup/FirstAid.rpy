...
translate pl strings:
    ...
    new "Removes all harmful effects from the target ally and recovers your hp and the hp of the target ally by %s. Grants immunity to the target ally for 2 turns.\nYou can use this skill on yourself."
