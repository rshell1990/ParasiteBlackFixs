...
# game/data/characters/faymore_anya/char.rpy:34
translate pl dialogue_anya_entry_dd8021a1:

    # ANYA @ talk "[player_name!t]."
    ANYA @ talk "[player_name!t]."

# game/data/characters/faymore_anya/char.rpy:39
translate pl anya_bye_60bc6fb9:

    # ANYA @ talk "Speak to Chanyi if you want to arrange... umm..."
    ANYA @ talk "Speak to Chanyi if you want to arrange... umm..."

# game/data/characters/faymore_anya/char.rpy:40
translate pl anya_bye_99c61a5c:
...
translate pl strings:
    ...
    # game/data/characters/faymore_anya/char.rpy:1
    old "Anya"
    new "Anya"
