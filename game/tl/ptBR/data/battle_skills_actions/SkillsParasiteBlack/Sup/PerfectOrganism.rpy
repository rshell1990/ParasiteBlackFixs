...
translate ptBR strings:
    ...
    new "Sacrifica o dano que você causa em 20%% por 2 turnos e aumenta o dano que seus aliados absorvem em 40%% por 2 turnos e recupera a energia de todos eles (exceto você) em %s."
