translate zh strings:
    ...
    old "DejaVu Sans"
    new "DejaVu Sans（西文字体）"

    # renpy/common/00accessibility.rpy:153
    old "Opendyslexic"
    new "Opendyslexic（阅读障碍友好字体）"
    ...
    new "此菜单中的选项旨在提高无障碍性。它们可能不适用于所有游戏，某些选项组合可能导致游戏无法运行。这不是游戏或引擎的问题。为了在更改字体时获得最佳效果，请尽量保持文本大小与原来相同。"
    ...
    new "此存档创建于其他设备。恶意构建的存档文件可能损害您的计算机。您是否信任此存档的创建者以及所有可能修改过该文件的人？"
    ...
    new "本程序包含遵循多种许可证的自由软件，包括MIT许可证和GNU宽通用公共许可证。完整的软件列表及源代码链接请见{a=https://www.renpy.org/l/license}此处{/a}。"
    ...
    new "Ren'Py 同步服务器没有此同步的副本。同步ID可能无效或已超时。"
    ...
    new "这将把您的存档上传至 {a=https://sync.renpy.org}Ren'Py 同步服务器{/a}。\n是否继续？"
    ...
    new "您可以使用此ID在另一台设备上下载您的存档。\n此同步将在一小时后过期。\nRen'Py 同步由 {a=https://www.renpy.org/sponsors.html}Ren'Py 的赞助者{/a} 支持。"
    ...
    new "其图形驱动程序可能已过时或运行不正常。这可能导致图形显示缓慢或不正确。"
    ...
    new "更多关于如何修复此问题的详细信息可在 {a=[url]}文档{/a} 中找到。"
...
# TODO: Translation updated at 2025-10-02 20:34
