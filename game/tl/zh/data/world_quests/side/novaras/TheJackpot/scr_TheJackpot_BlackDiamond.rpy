...
translate zh qst_jackpot_black_diamond_winward_cd1bd79a:

    # MR_WINWARD @ happy "Ahh! You've made it, lad!"
    MR_WINWARD @ happy "啊！你终于来了，小伙子！"
...
translate zh qst_jackpot_black_diamond_winward_879f2eeb:

    # BANDIT "Is this your friend?"
    BANDIT "这是你的朋友？"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:38
translate zh qst_jackpot_black_diamond_winward_b8e50d2d:
...
translate zh qst_jackpot_black_diamond_damzel_vulshan_8ce1718b:
    ...
    VULSHAN_GUARD "许多顶尖帮派头目和商人都参与赌局；一旦名字在名单上，你就{i}必须{/i}出席，否则将没收买入金额作为罚金。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:76
translate zh qst_jackpot_black_diamond_damzel_vulshan_9ea0639d:
...
translate zh qst_jackpot_black_diamond_damzel_vulshan_49b93b95:
    ...
    VULSHAN_GUARD "要是新人直接赢下大局会引来太多疑问；太多疑问对生意不好。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:87
translate zh qst_jackpot_black_diamond_damzel_vulshan_6384b220:
    ...
    VULSHAN_GUARD "我们会让水晶眼赢{i}刚好够{/i}你朋友带些钱离开，但不会让他满载而归。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:88
translate zh qst_jackpot_black_diamond_damzel_vulshan_67a91629:

    # VULSHAN_GUARD "Iz all I can think of..."
    VULSHAN_GUARD "我能想到的就这些了..."
...
translate zh qst_jackpot_black_diamond_damzel_tarek_left_8a4f50b4:
    ...
    VULSHAN_GUARD "塔雷克待我不薄。如果你说的是真的，我和这里许多人会对你的存在睁只眼闭只眼。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:137
translate zh qst_jackpot_black_diamond_damzel_tarek_left_44c26503:
...
translate zh qst_jackpot_black_diamond_damzel_tarek_left_434f3894:

    # MC "...Noted."
    MC "...知道了。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:139
translate zh qst_jackpot_black_diamond_damzel_tarek_left_55105e0e:
...
translate zh qst_jackpot_black_diamond_damzel_tarek_left_27b89873_1:

    # VULSHAN_GUARD "...Finish whatever business you have with your friend and leave."
    VULSHAN_GUARD "...办完你朋友的事就离开。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:150
translate zh qst_jackpot_black_diamond_damzel_tarek_left_6ba65ea3_1:

    # VULSHAN_GUARD "Do not linger, others may... {i}ask their own questions.{/i}"
    VULSHAN_GUARD "别逗留，其他人可能...{i}提出他们自己的问题。{/i}"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:154
translate zh qst_jackpot_black_diamond_damzel_tarek_left_33cb0197_1:

    # VULSHAN_GUARD "You...!"
    VULSHAN_GUARD "你...！"

# game/data/world_quests/sside/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:155
translate zh qst_jackpot_black_diamond_damzel_tarek_left_d998012a_1:

    # VULSHAN_GUARD "Do whatever it iz you've come to down and then get the fuck out!"
    VULSHAN_GUARD "办完你的事就他妈赶紧滚！"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:156
translate zh qst_jackpot_black_diamond_damzel_tarek_left_6f9a7c3a_1:

    # VULSHAN_GUARD "I - I mean it!"
    VULSHAN_GUARD "我——我是认真的！"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:157
translate zh qst_jackpot_black_diamond_damzel_tarek_left_bd1b63fc_1:

    # "The Vulshan guard quickly scurried away."
    "瓦尔珊守卫迅速溜走了。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:159
translate zh qst_jackpot_black_diamond_damzel_tarek_left_8a8b7e4e_1:

    # MC "({i}*Sigh*{/i})"
    MC "({i}*叹气*{/i})"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:160
translate zh qst_jackpot_black_diamond_damzel_tarek_left_9608d8e2_1:

    # MC "(That was a close one.)"
    MC "(真是好险。)"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:163
translate zh qst_jackpot_black_diamond_damzel_tarek_left_c8d482cc:

    # VULSHAN_GUARD "There was no raid! This is a lie, a sham!"
    VULSHAN_GUARD "根本没有突袭！这是谎言，是骗局！"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:166
translate zh qst_jackpot_black_diamond_damzel_tarek_left_5d9bcd78:

    # VULSHAN_GUARD "You expect me to believe zat nonsense?!"
    VULSHAN_GUARD "你以为我会相信这种胡话？！"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:168
translate zh qst_jackpot_black_diamond_damzel_tarek_left_55105e0e_1:
...
translate zh qst_jackpot_black_diamond_damzel_assassinated_32915c92:

    # MC "(...Shit.)"
    MC "(...该死。)"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:205
translate zh qst_jackpot_black_diamond_damzel_assassinated_f3586903:
...
translate zh qst_jackpot_black_diamond_damzel_assault_29d1df93:
    ...
    VULSHAN_GUARD "塔雷克死了，随着他的死，黑钻石作为呃，用你们的话说，{i}中立地带{/i}的协议也失效了。"
...
translate zh qst_jackpot_black_diamond_winward_2_aee96aa8:
    ...
    "经过一段耐心等待，响亮的锣声响起，各式玩家起身聚集，两扇巨大的金属门缓缓吱呀开启。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:269
translate zh qst_jackpot_black_diamond_winward_2_f1d59334:
...
translate zh qst_jackpot_black_diamond_winward_2_51772022:

    # MR_WINWARD @ laugh "Make us rich lad! Heh!"
    MR_WINWARD @ laugh "让咱们发财吧小子！嘿！"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:271
translate zh qst_jackpot_black_diamond_winward_2_bc9b5fb7:

    # MR_WINWARD @ happy "Oh, and don't forget this!"
    MR_WINWARD @ happy "哦，别忘了这个！"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:272
translate zh qst_jackpot_black_diamond_winward_2_78b9c4f4:

    # "Mr Winward handed me over his buy-in, a large bag of coins."
    "温沃德先生将他的入场筹码——一大袋钱币递给我。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:273
translate zh qst_jackpot_black_diamond_winward_2_818510b3:
...
translate zh qst_jackpot_black_diamond_winward_2_014c3ab3:
    ...
    "室内，几个人影围坐在华丽的大桌旁，其中一两个短暂抬头与我对视，随即又移开目光。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:277
translate zh qst_jackpot_black_diamond_winward_2_0ea38733:
    ...
    "房间里我谁也不认识，但从许多人身穿的丝绸长袍和佩戴的华丽珠宝来看，他们不是富商就是些小贵族。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:278
translate zh qst_jackpot_black_diamond_winward_2_efeeb221:
...
translate zh qst_jackpot_black_diamond_winward_2_f9f74572:
    ...
    MR_WINWARD @ angry "解决办法就是赢，小子！"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:317
translate zh qst_jackpot_black_diamond_winward_2_afc6b280:

    # MR_WINWARD "Bahh! I'm gonna grab another drink! You can dither as much as you like!"
    MR_WINWARD "呸！我再去拿杯酒！你爱犹豫就犹豫吧！"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:325
translate zh qst_jackpot_black_diamond_game_7072cc8f:

    # "Looking down, bags of coins surrounding me, it dawned on me I'd somehow won."
    "低头看着周围成袋的钱币，我意识到自己居然赢了。"
...
translate zh qst_jackpot_black_diamond_game_c4e78d74:
...
translate zh qst_jackpot_black_diamond_game_26f287b7:
    ...
    MR_WINWARD @ angry "你这该死的白痴！怎么会输成那样？！"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:358
translate zh qst_jackpot_black_diamond_game_1616976d:

    # MR_WINWARD @ angry "That's it! I've had enough of ya!"
    MR_WINWARD @ angry "够了！我受够你了！"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:359
translate zh qst_jackpot_black_diamond_game_24a7c5ec:

    # "In a fit of rage, Mr Winward stormed off before I could stop him."
    "温沃德先生暴怒之下冲了出去，我来不及阻止。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:360
translate zh qst_jackpot_black_diamond_game_a616cf58:

    # MC "(Shit, I should follow him before he does something even more reckless!)"
    MC "（妈的，得在他干出更不要命的事之前跟上他！）"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:367
translate zh qst_jackpot_black_diamond_vulshan_distraction_25aa119e:

    # VULSHAN_GUARD "Have you given my proposal some thought?"
    VULSHAN_GUARD "考虑过我的提议了吗？"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:370
translate zh qst_jackpot_black_diamond_vulshan_distraction_5e2dfab4:

    # VULSHAN_GUARD "Very good."
    VULSHAN_GUARD "很好。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:373
translate zh qst_jackpot_black_diamond_vulshan_distraction_dfbd5559:

    # VULSHAN_GUARD "I shall send some of the girls over towards your friend, and they shall keep him occupied."
    VULSHAN_GUARD "我会派些姑娘去陪你朋友，让她们缠住他。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:374
translate zh qst_jackpot_black_diamond_vulshan_distraction_9c914759:

    # MC @ think "How do you plan to stop him from hearing the announcement?"
    MC @ think "你打算怎么不让他听到宣布？"
...
translate zh qst_jackpot_black_diamond_vulshan_distraction_05ca3c92:
    ...
    "两位女郎将已微醺的温沃德先生引到私人房间，他乐得让两位美女分散注意，轻易就范。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:381
translate zh qst_jackpot_black_diamond_vulshan_distraction_7e9ae26c:
...
translate zh qst_jackpot_black_diamond_vulshan_distraction_b9e4bde4:
    ...
    "随着响亮的锣声，部分玩家及保镖开始走向另一间私人厅室。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:387
translate zh qst_jackpot_black_diamond_vulshan_distraction_68234420:

    # VULSHAN_GUARD "The game is beginning... I must go..."
    VULSHAN_GUARD "游戏开始了...我得走了..."

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:389
translate zh qst_jackpot_black_diamond_vulshan_distraction_1e4fef88:

    # "The Vulshan guard turned and left to join the others; the bulky metal doors were then closed with a low 'THUD' behind them."
    "瓦尔珊守卫转身离开加入他人；沉重的金属门随后低沉地'砰'一声关闭。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:390
translate zh qst_jackpot_black_diamond_vulshan_distraction_d461251b:

    # MC "Hmm, what should I do now?"
    MC "嗯，现在该怎么办？"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:395
translate zh qst_jackpot_black_diamond_vulshan_distraction_5cf3a9b0:

    # MC "I'm still considering it."
    MC "我还在考虑。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:396
translate zh qst_jackpot_black_diamond_vulshan_distraction_dc1fbe17:

    # VULSHAN_GUARD "The game starts soon."
    VULSHAN_GUARD "游戏快开始了。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:397
translate zh qst_jackpot_black_diamond_vulshan_distraction_cb1c0fbd:

    # VULSHAN_GUARD "Consider my offer, friend."
    VULSHAN_GUARD "考虑我的提议，朋友。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:402
translate zh qst_jackpot_black_diamond_vulshan_checkup_4cc9a28e:
...
translate zh qst_jackpot_black_diamond_vulshan_checkup_30695688:
    ...
    "当我嘎吱一声推开门查看老人时，温沃德先生醉醺醺地挥舞着半空的酒瓶，两个女孩正取悦着他，她们一边用手抚摸他，一边用舌头温柔地舔舐他的身体。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:413
translate zh qst_jackpot_black_diamond_vulshan_checkup_d1b4b020:

    # MR_WINWARD "I'm gonna be - {i}*Hiccup!*{/i} A richhh mhann shoonnn!"
    MR_WINWARD "我就要——{i}*嗝！*{/i}变成有钱银啦！"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:414
translate zh qst_jackpot_black_diamond_vulshan_checkup_8f974385:

    # MR_WINWARD "Hehehe! Yhou ladies shureee are - Mhmm! P-Pretty!"
    MR_WINWARD "嘿嘿嘿！你们这些妞儿可——嗯！真-真漂亮！"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:415
translate zh qst_jackpot_black_diamond_vulshan_checkup_2f8a1bdf:

    # BLACK_DIAMOND_PROSTITUTE "Oh yes! You shall be zuch rich man!"
    BLACK_DIAMOND_PROSTITUTE "噢当然！您会成为超级富豪的！"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:416
translate zh qst_jackpot_black_diamond_vulshan_checkup_f1770336:

    # OTHER_BLACK_DIAMOND_PROSTITUTE "Iz this fool even listening?"
    OTHER_BLACK_DIAMOND_PROSTITUTE "这蠢货真能听进去吗？"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:417
translate zh qst_jackpot_black_diamond_vulshan_checkup_7ea79e46:

    # BLACK_DIAMOND_PROSTITUTE "Shhh! Just keep him happy new girl!"
    BLACK_DIAMOND_PROSTITUTE "嘘！让他开心点就行，新人！"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:420
translate zh qst_jackpot_black_diamond_vulshan_checkup_aa28b5c1:

    # "The two woman laughed and played along, stroking the old man's cock faster as he grunted and groaned happily."
    "两个女人笑着配合，随着老人愉悦的呻吟声加快套弄他肉棒的速度。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:421
translate zh qst_jackpot_black_diamond_vulshan_checkup_22fe9e09:

    # "Every so often he'd take a swig from the bottle, or attempted to grope the service girls breasts or asses."
    "他不时灌一口酒，或者试图抓捏服务女郎的胸脯和臀部。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:422
translate zh qst_jackpot_black_diamond_vulshan_checkup_b40cc606:

    # MR_WINWARD "Ahhh! Shooo mhuchh! Mhmm! Bhetter thannn - {i}*Hiccup!*{/i} Thathhh oldhhh bitchh! Hehe!"
    MR_WINWARD "啊啊！太-太爽了！嗯！比那个——{i}*嗝！*{/i}老-老婊子强多啦！嘿嘿！"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:423
translate zh qst_jackpot_black_diamond_vulshan_checkup_5e619c4a:

    # OTHER_BLACK_DIAMOND_PROSTITUTE "{i}Who is he talking about?{/i}"
    OTHER_BLACK_DIAMOND_PROSTITUTE "{i}他在说谁啊？{/i}"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:424
translate zh qst_jackpot_black_diamond_vulshan_checkup_59577d2b:

    # BLACK_DIAMOND_PROSTITUTE "{i}No idea, just smile and let us finish him quickly!{/i}"
    BLACK_DIAMOND_PROSTITUTE "{i}管他呢，笑着快点完事就行！{/i}"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:425
translate zh qst_jackpot_black_diamond_vulshan_checkup_31c31df8:
    ...
    "随着两个女人持续套弄老人的肉棒，他猪猡般的愉悦呻吟声逐渐升高，直到..."

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:430
translate zh qst_jackpot_black_diamond_vulshan_checkup_7787576e:

    # MR_WINWARD "OOOOOOOOOOOOH!"
    MR_WINWARD "噢噢噢噢噢噢噢噢！"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:431
translate zh qst_jackpot_black_diamond_vulshan_checkup_2fb8dd34:

    # "The old man finally finished, covering the girls hands in his warm seed."
    "老人终于射精，温热的精液沾满了女孩们的双手。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:432
translate zh qst_jackpot_black_diamond_vulshan_checkup_f64dd5a5:

    # OTHER_BLACK_DIAMOND_PROSTITUTE "{i}Urghh! Now what?{/i}"
    OTHER_BLACK_DIAMOND_PROSTITUTE "{i}呃！现在怎么办？{/i}"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:433
translate zh qst_jackpot_black_diamond_vulshan_checkup_9caff07e:

    # BLACK_DIAMOND_PROSTITUTE "{i}Must I teach you everything? Clean him up!{/i}"
    BLACK_DIAMOND_PROSTITUTE "{i}什么事都要我教吗？给他清理干净！{/i}"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:434
translate zh qst_jackpot_black_diamond_vulshan_checkup_ddb31f27:
...
translate zh qst_jackpot_black_diamond_vulshan_checkup_4b3b2798:
...
translate zh qst_jackpot_black_diamond_vulshan_checkup_0e45a7a0:
...
translate zh qst_jackpot_black_diamond_vulshan_couch_3ebf6746:
...
translate zh qst_jackpot_after_diamond_game_4ca94967:
...
translate zh qst_jackpot_after_diamond_game_f6fb58be:
    ...
    "在我让冷血行为的严重性压垮我之前，我迅速逃离，以免有人偶然发现这可怕的场景。"
...
translate zh qst_jackpot_black_diamond_vip_scene_bc517590:
    ...
    "当女孩将我的鸡巴更深地吞入喉咙时，我愉悦地呻吟着，同时诱惑地扭动着她圆润的臀部。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:600
translate zh qst_jackpot_black_diamond_vip_scene_530e6c76:
    ...
    "女孩的舌尖不时绕着我的肉棒挑拨抽打，她一边发出炙热的呜咽，一边含糊地传来赞赏之词。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:601
...
# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:603
translate zh qst_jackpot_black_diamond_vip_scene_f3f7ffc4:
    ...
    "当她轻车熟路的挑逗让我感到睾丸紧缩上提时，我咬紧牙关低吼一声警告她我快要到了。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:604
...
translate zh qst_jackpot_black_diamond_vip_scene_c614ef8f:
    ...
    "很快，她的舌尖挑过我龟头，再滑下去将我整根肉棒深喉含入，就这么含住不放，满怀期待地等待着。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:607
translate zh qst_jackpot_black_diamond_vip_scene_df527f38:
    ...
    "经过她长久的连续挑逗，我终于被她那张小嘴彻底征服，一把抓住她的后脑勺，攥着她柔软的发丝，将浓稠的精液灌入她的喉咙。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:608
...
translate zh qst_jackpot_black_diamond_vip_scene_6c79331e:
    ...
    "当精液涌入她的喉咙时，我注意到她的腿微微颤抖，一些甜美、闪亮的汁液从她腿间滴落到地板上。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:627
translate zh qst_jackpot_black_diamond_vip_scene_76302dec:

    # "{i}Had she just finished from sucking my cock alone?{/i}"
    "{i}她光是吸我的鸡巴就高潮了吗？{/i}"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:628
translate zh qst_jackpot_black_diamond_vip_scene_34d9091c:

    # "The girl eagerly swallowed and licked up every last hint of my seed, making sure not to waste a drop."
    "女孩急切地吞咽并舔舐我精液的每一丝痕迹，确保不浪费一滴。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:629
translate zh qst_jackpot_black_diamond_vip_scene_f3de1b92:

    # "Satisfied my member had been cleaned, she pulled back, wipping her mouth clean with a cloth delicately."
    "确信我的阳物已被舔舐干净，她松开嘴向后靠去，优雅地用布擦了擦嘴角。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:630
translate zh qst_jackpot_black_diamond_vip_scene_949e47d7:

    # BLACK_DIAMOND_SERVICE_GIRL "谢谢款待，先生，呼呼 {image=[ICON.HEART]}"
    BLACK_DIAMOND_SERVICE_GIRL "谢谢您的款待，先生，呼呼 {image=[ICON.HEART]}"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:634
translate zh qst_jackpot_black_diamond_vip_scene_81effd41:

    # "Without another word, the girl rose to her feet, gently bowed and left the room."
    "女孩一言不发地站起身，轻轻鞠躬后离开了房间。"

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:635
translate zh qst_jackpot_black_diamond_vip_scene_99cc92d0:

    # "After allowing myself a few moments to collect myself, I headed outside..."
    "允许自己花片刻时间恢复后，我走向外面..."

# game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:636
translate zh qst_jackpot_black_diamond_vip_scene_50ba1287:

    # MC "（好吧，这至少肯定打发了一些时间，现在怎么办？）"
    MC "(好吧，那肯定打发了一些时间，现在呢？)"

translate zh strings:

    # game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:10
    old "No (does nothing)"
    new "不(什么也不做)"
    ...
    # game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:112
    old "Tarek fled because the Vulshan and the Kazhar were about to kill him!"
    new "塔雷克逃走了，因为武尔山和卡扎人要杀他！"

    # game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:145
    old "I had a tip and warned Tarek a raid from inquisitors was coming soon. (Lie)"
    new "我有个内线消息，警告塔雷克审判官的突袭即将来临。（谎言）"
    ...
    # game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:368
    old "Tell 'Crystal eyes' the deal is on."
    new "告诉'水晶眼'交易继续。"

    # game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:403
    old "Yes."
    new "是。"
    ...
    # game/data/world_quests/side/novaras/TheJackpot/scr_TheJackpot_BlackDiamond.rpy:566
